      ...
      <div className="flex space-x-2">
        <div className="relative flex-grow">
          <input
            ...
            className="search w-full py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-pl-1"
          />
          <div className="absolute left-1 top-2.5 text-indigo-600 dark:text-indigo-400">
